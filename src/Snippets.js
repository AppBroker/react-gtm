...
const Snippets = {
  tags: function ({ id, events, dataLayer, dataLayerName, preview, auth, gTagOverride }) {
    const gtm_auth = `&gtm_auth=${auth}`
    const gtm_preview = `&gtm_preview=${preview}`
    const gtm_path = gTagOverride === '' ? '//www.googletagmanager.com/gtm.js' : gTagOverride;
    ...
    const script = `
      (function(w,d,s,l,i){w[l]=w[l]||[];
        ...
        j.async=true;j.src="${gtm_path}?id='+i+dl+'${gtm_auth}${gtm_preview}&gtm_cookies_win=x'";
